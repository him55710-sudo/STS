...
디자인 시스템: 크림 캔버스, 코랄→와인 그라데이션 밴드(시작·끝), 흰 카드(선 0.5mm, 라운드 10mm), 강조색은 코랄·와인 두 가지만 사용. 배너에는 정량 수치를 넣지 않았다(근거가 필요한 수치는 제외). 개발 과정 출처는 `docs/PDCA.md`, `docs/VISION.md`; 방향 설정 과정은 팀 인터뷰 내용.
